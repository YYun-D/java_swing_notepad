...
public class test extends JFrame  {
	...
	ImageIcon iconNote = new ImageIcon("test.png");
	ImageIcon iconNote1 = new ImageIcon("test1.png");
	int testcnt;
	...
	//	startButton1.setBounds(180, 300, 200, 50);
		...
		wordLabel.setBounds(0, 194, 480, 80);
		...
		cntBar.setForeground(new Color(0x84e1f0));
