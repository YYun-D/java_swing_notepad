...
public class test extends JFrame  {
	...
	ImageIcon iconO = new ImageIcon("O.png"); 					// O 아이콘
	ImageIcon iconX = new ImageIcon("XX.png"); 					// X 아이콘
	ImageIcon backgroundImg = new ImageIcon("blue.jpg"); 		// 처음 배경
	ImageIcon backgroundImg1 = new ImageIcon("blue1.jpg");		// 시험창 배경
    JPanel panel = new JPanel();								// 배경 라벨을 넣기 위한 판넬
	JLabel label1 = new JLabel();								// 배경이 들어간 라벨
	int testcnt;
	...
	//주어진 String subjectWord를 wav 파일로 변환 후 읽어주기
